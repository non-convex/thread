...
export const PROGRESS_SUMMARY_SYSTEM_PROMPT = [
  ...
  "1. A message labeled `Project-state background`. It is the newly generated cumulative project-state summary and may include earlier work from this turn. Use it only as background for understanding names, decisions, and constraints. Do not summarize or restate it unless a fact is necessary to explain the current turn.",
