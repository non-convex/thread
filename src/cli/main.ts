...
async function main(): Promise<void> {
  ...
  const app = await ThreadApp.open({
    ...
    dreamer: {
      ...
      ...(dreamerConfig?.idleTurns !== undefined ? { idleTurns: dreamerConfig.idleTurns } : {}),
      ...(dreamerConfig?.idleMinutes !== undefined ? { idleMs: dreamerConfig.idleMinutes * 60_000 } : {}),
      ...(dreamerConfig?.maxWaitMinutes !== undefined ? { maxWaitMs: dreamerConfig.maxWaitMinutes * 60_000 } : {}),
      ...(dreamerConfig?.maxSteps !== undefined ? { maxSteps: dreamerConfig.maxSteps } : {}),
      ...(dreamerConfig?.maxRuntimeMinutes !== undefined ? { maxRuntimeMs: dreamerConfig.maxRuntimeMinutes * 60_000 } : {}),
    },
