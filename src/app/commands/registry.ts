...
const THREAD_COMMAND_PREFIX = "/thread";

export async function routeThreadCommand(registry: CommandRegistry, input: string, context: ThreadCommandContext): Promise<CommandResult | undefined> {
